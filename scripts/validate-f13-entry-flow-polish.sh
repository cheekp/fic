...
require_file "docs/plans/active/F13-entry-flow-polish.md"
require_file "docs/plans/completed/F12-company-brand-surfaces.md"
require_file "docs/specs/F13-entry-flow-polish/REQUIREMENTS.md"
require_file "docs/specs/F13-entry-flow-polish/ACCEPTANCE.md"
...
require_text "F13 Entry Flow Polish" "docs/plans/active/F13-entry-flow-polish.md"
...
require_text "SignupPage_ReadsAsShortShopCreationStep" "tests/Fic.Platform.Web.Tests/CompanyBrandSurfaceTests.cs"
...
echo "F13 entry flow polish validation passed."
