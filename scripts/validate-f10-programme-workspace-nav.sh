...
require_text "Run daily loyalty from here" "src/Fic.Platform.Web/Components/Pages/VendorWorkspace.razor"
require_text "Daily use for this programme" "src/Fic.Platform.Web/Components/Pages/VendorWorkspace.razor"
require_text "Programmes -> Operate" "docs/specs/F10-programme-workspace-nav/ACCEPTANCE.md"
...
require_text "DefaultWorkspaceRoute_LandsInProgrammesOperate" "tests/Fic.Platform.Web.Tests/VendorWorkspaceComponentTests.cs"
