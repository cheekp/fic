...
export default function HomePage() {
  return (
    <main className="space-y-8" style={buildBrandCssVars(ficPortalTheme)}>
      <PublicPortalHeader />

      <section className="relative overflow-hidden rounded-3xl border border-border/70 p-5 text-slate-100 shadow-luxe sm:p-8" style={{ backgroundImage: "linear-gradient(145deg, var(--brand-hero-start), var(--brand-hero-end))" }}>
        <div
          aria-hidden
        ...
        <div className="relative grid gap-7">
          <div className="grid gap-6 lg:grid-cols-[1.06fr_0.94fr]">
            <section className="space-y-5">
              <p className="brand-title-kicker">Launch in minutes</p>
              ...
              <p className="max-w-2xl text-[1.06rem] leading-8 text-slate-200/95 sm:text-[1.2rem]">
                Launch a branded loyalty programme your customers can join and use immediately.
              </p>

              <div className="flex flex-wrap gap-3 pt-1">
                <Button asChild size="lg" className="brand-gradient-button min-w-56 hover:brightness-105">
            ...
            <aside className="brand-hero-panel overflow-hidden rounded-2xl border border-white/20 backdrop-blur">
              <img
      ...
      <section className="grid gap-4 sm:grid-cols-3">
        <article className="glass-panel p-5">
          ...
          <p className="mt-2 text-sm text-foreground/75">Create your shop, set your brand direction, and publish your first programme.</p>
        </article>
        <article className="glass-panel p-5">
